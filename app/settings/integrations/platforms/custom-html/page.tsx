        ...
        <header className="sx-top">
          <div className="sx-topLeft">
            <div className="cb-heroTitle">
              ...
              <div>
              <h1 className="sx-h1">Custom HTML</h1>
              <p className="sx-sub">
                Install CavBot on any website with one script bundle that brings Arcade, widgets, analytics, and CavAi together.
              </p>
...
<br /><br /><br /><br />
        <section className="sx-panel cb-installPanel cb-spacedPanel" aria-label="Install steps">
          <header className="sx-panelHead">
            <div>
              <p className="sx-footK">Section A — Install in &lt;head&gt; (recommended)</p>
              <p className="sx-sub">
                Dropping scripts before the closing <code>&lt;/head&gt;</code> keeps Arcade, widgets, analytics, and CavAi fast and reliable.
              </p>
              <br />
            </div>
          </header>
          <div className="sx-body">
            <ul className="cb-installBullets">
              <li>Paste scripts before the closing <code>&lt;/head&gt;</code> tag so Arcade, widgets, analytics, and CavAi load early.</li>
              <li>This works on any HTML page, keeping badge widgets visible and telemetry active at all times—even if users eventually land on 404 routes.</li>
              <li>The Arcade loader keeps visitors in the experience while analytics and CavAi continue collecting insights during 404 responses.</li>
            </ul>
         <br />   <div className="cb-installSnippets">
              <SnippetBlock
                id="arcade-404"
        ...
        <section className="sx-panel cb-spacedPanel" aria-label="Dedicated 404 instructions">
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub">
                If your hosting platform allows a custom <code>404.html</code>, paste the Arcade loader there for determinism. 
              </p>
            </div>
          </header>
          <div className="sx-body cb-dedicated404">
            <div className="cb-dedicatedRow">
              <p className="sx-status-sub cb-dedicatedSentence">
                This is the most deterministic setup because CavBot only runs when the server returns an actual 404 response.
                Even if the loader already detects 404 pages, adding the meta tag below is a best practice guardrail.
              </p>
            ...
            <p className="sx-status-sub cb-dedicatedFollow">
              ...
              <code>data-cavbot-page-type=&quot;404&quot;</code> attribute on <code>&lt;body&gt;</code> to make the recovery intent explicit.
            </p>
          </div>
        </section>
        ...
        <section className="sx-panel cb-spacedPanel" aria-label="Quick verification">
          ...
          <div className="sx-body cb-testSection">
            <ol className="cb-testList">
              <li>Paste the snippets above into your site’s <code>&lt;head&gt;</code> or the custom <code>404.html</code>.</li>
              <li>Publish or redeploy your site so the updated HTML is live.</li>
              <li>
                Visit an invalid route like <code>https://YOURDOMAIN.com/this-route-does-not-exist</code> and expect the CavBot Arcade loader to appear.
              </li>
            </ol>
         <br /><br />   <p className="sx-status-sub">
        ...
        <section className="sx-panel cb-spacedPanel" aria-label="CavCode">
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub">
                Drop your HTML file into CavCode to add snippets, validate markup, and save a refreshed build. CavCode is an optional helper; your deploy process still controls production.
              </p>
            </div>
