        ...
        <header className="sx-top">
          <div className="sx-topLeft">
            <div className="cb-heroTitle">
              ...
              <div>
              <h1 className="sx-h1">Squarespace Integration</h1>
              <p className="sx-sub">
                Install CavBot on Squarespace to serve a secured, interactive CavBot recovery experience on your 404 route.
              </p>
          ...
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub cb-longCopy">
                This script instructs Squarespace to load CavBot Arcade, widgets, analytics, and CavAi while keeping your 404 route secure and interactive.
              </p>
              <p className="sx-status-sub cb-longCopy">
                Squarespace supports site-wide code injection via Settings → Advanced → Code Injection; keep this guide visible so you can paste the loader into the Header field exactly once.
              </p>
            </div>
          </header>
          <div className="sx-body">
            <div className="cb-pathIntro">
              <p className="sx-footK">Advanced Settings → Code Injection</p>
              <br />
              <br />
              <p className="sx-status-sub">
                Injecting the loader in the global Header lets CavBot detect 404 traffic consistently across every published page and error route.
              </p>
            </div>
            <div className="cb-stepGrid">
              <article className="cb-stepEntry">
                <strong>Open Squarespace Dashboard</strong>
                <br />
                <br />
                <p className="sx-status-sub">
                  Log in to your Squarespace account and select the website you want to protect.
                </p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  In the left sidebar, go to: Settings → Advanced.
                </p>
              </article>
              <article className="cb-stepEntry">
                <strong>Open Code Injection</strong>
                <br />
                <br />
                <p className="sx-status-sub">Click “Code Injection.”</p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  Paste the CavBot Arcade Loader snippet (generated below) into Header. Header placement is preferred for reliable detection and fastest activation.
                </p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  Click Save. Squarespace applies code immediately (no separate publish step required).
                </p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  Open your live site in a new tab and visit a URL that does not exist, for example https://yourdomain.com/this-route-does-not-exist. Your Squarespace 404 page will load and CavBot Arcade should mount automatically.
                </p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  Return to CavBot → Settings → Integrations → Squarespace. The detection panel below should flip from “Not detected” to “Detected” and display the last seen timestamp, origin, and selected game.
                </p>
              </article>
            </div>
          </div>
        ...
        <section className="sx-panel cb-spacedPanel" aria-label="Loader snippets">
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub">
                The loader, widget, analytics, and CavAi snippets now sit below the install steps so you can grab the cards after pasting the loader into Code Injection.
              </p>
            </div>
          </header>
          <div className="sx-body">
        ...
        <section className="sx-panel cb-spacedPanel" aria-label="Dedicated 404 instructions">
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub">
                If your Squarespace plan gives you a customizable 404 page or you are using Developer Mode, paste the Arcade loader there for determinism.
              </p>
            </div>
          </header>
          <div className="sx-body cb-dedicated404">
            <div className="cb-dedicatedRow">
              <p className="sx-status-sub cb-dedicatedSentence">
                This is the most deterministic setup because CavBot only runs when Squarespace returns a real 404 response.
            ...
            <p className="sx-status-sub cb-dedicatedFollow">
              ...
              <code>data-cavbot-page-type=&quot;404&quot;</code> attribute on <code>&lt;body&gt;</code> so Squarespace knows this page serves 404 traffic.
            </p>
          </div>
        </section>
        ...
        <section className="sx-panel cb-spacedPanel" aria-label="Quick verification">
          ...
          <div className="sx-body cb-testSection">
            <ol className="cb-testList">
              <li>Save the Code Injection entry in Squarespace so the CavBot snippet is live on your published site.</li>
              <li>Open your published Squarespace site in a new tab and navigate to a URL that does not exist.</li>
            ...
            <p className="sx-status-sub cb-testParagraph">
              Squarespace sometimes caches aggressively; hard refresh the 404 page and wait ~1–2 minutes if detection does not flip immediately.
            </p>
            <p className="sx-status-sub cb-testParagraph">
              The domain MUST be added to CavBot&apos;s Origin Allowlist or verification will fail.
            </p>
            <p className="sx-status-sub cb-testParagraph">
              If your site uses both www and non-www domains, add both to the allowlist.
            </p>
            <p className="sx-status-sub cb-testParagraph">
              If you maintain staging or multiple site versions, make sure the snippet lives only on the published domain to keep detection accurate.
            </p>
          </div>
        </section>
          ...
          <div className="sx-body cb-troubleshoot">
            ...
            <details>
              ...
              <ul>
                ...
                <li>Ensure the loader snippet lives in Code Injection’s Header field so it runs before the page renders.</li>
                <li>Squarespace caches aggressively; hard refresh the 404 page and wait ~1–2 minutes after saving if detection does not flip immediately.</li>
              </ul>
            </details>
          </div>
        </section>
          ...
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub">
                ...
                to validate your snippet or manage exported HTML/CSS before publishing to squarespace.
              </p>
            </div>
