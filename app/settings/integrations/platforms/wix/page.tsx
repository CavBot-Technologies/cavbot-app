...
export default function CustomHtmlPlatformPage() {
        ...
        <header className="sx-top">
          <div className="sx-topLeft">
            <div className="cb-heroTitle">
              ...
              <div>
              <h1 className="sx-h1">Wix Integration</h1>
              <p className="sx-sub">
                Install CavBot scripts on Wix so your site can serve a secured, interactive CavBot recovery experience.
              </p>
        ...
        <section className="sx-panel cb-installPanel cb-spacedPanel" aria-label="Install steps">
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub">
                This script instructs Wix to load CavBot Arcade, widgets, analytics, and CavAi while keeping your 404 route secure and interactive.
              </p><br />
            </div>
          </header>
          <div className="sx-body">
            <div className="cb-stepGrid">
              <article className="cb-stepEntry">
                <strong>Open Wix Dashboard</strong>
                <br />
                <br />
                <p className="sx-status-sub">
                  Go to your Wix dashboard for the site you want to protect.
                </p>
              </article>
              <article className="cb-stepEntry">
                <strong>Open Custom Code</strong>
                <br />
                <br />
                <p className="sx-status-sub">
                  In the left sidebar, go to Settings → Advanced Settings → Custom Code. If &quot;Advanced Settings&quot; is not visible, use Settings → Custom Code instead.
                </p>
              </article>
              <article className="cb-stepEntry">
                <strong>Add CavBot loader script</strong>
                <br />
                <br />
                <p className="sx-status-sub">
                  Click &quot;+ Add Custom Code&quot;, paste the CavBot Arcade Loader snippet below, apply it to &quot;All pages&quot;, and set the placement to &quot;Head&quot;. If your plan only allows Body placement, choose &quot;Body - end&quot; (Head is preferred).
                </p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  Save the custom code entry and publish your Wix site — Wix does not apply new code until the site is published.
                </p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  Open a new tab, visit your live Wix site, and go to a path that does not exist (e.g. https://yourdomain.com/this-route-does-not-exist). A properly configured 404 should load the CavBot Arcade experience.
                </p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  Return to CavBot → Settings → Integrations → Wix. The verification panel below should flip from &quot;Not detected&quot; to &quot;Detected&quot; and report the last seen timestamp, origin, and selected game.
                </p>
              </article>
            </div><br />
        ...
        <section className="sx-panel cb-spacedPanel" aria-label="Dedicated 404 instructions">
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub">
                If your Wix plan lets you manage a custom 404 page, paste the Arcade loader there for determinism.
              </p>
            </div>
          </header>
          <div className="sx-body cb-dedicated404">
            <div className="cb-dedicatedRow">
              <p className="sx-status-sub cb-dedicatedSentence">
                This is the most deterministic setup because CavBot only runs when Wix returns a real 404 response.
            ...
            <p className="sx-status-sub cb-dedicatedFollow">
              ...
              <code>data-cavbot-page-type=&quot;404&quot;</code> attribute on <code>&lt;body&gt;</code> so Wix knows this page serves 404 traffic.
            </p>
          </div>
        </section>
        ...
        <section className="sx-panel cb-spacedPanel" aria-label="Quick verification">
          ...
          <div className="sx-body cb-testSection">
            <ol className="cb-testList">
              <li>Publish the custom code entry in Wix after saving it so the snippet is live on every page.</li>
              <li>Open your published Wix site in a new tab and navigate to a URL that does not exist.</li>
         ...
         <br /><br />   <p className="sx-status-sub cb-testParagraph">
            ...
            <p className="sx-status-sub cb-testParagraph">
              Wix caches custom code changes; hard refresh the 404 page, confirm the site was published, and wait 1-2 minutes if detection does not flip immediately.
            </p>
            <p className="sx-status-sub cb-testParagraph">
              Make sure the site domain is in CavBot&apos;s Origin Allowlist or verification will never move to Detected.
            </p>
          </div>
        </section>
          ...
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub">
                ...
                to inspect or manage your Wix custom code without leaving CavBot. CavCode is an optional helper; your deploy process still controls production.
              </p>
            </div>
