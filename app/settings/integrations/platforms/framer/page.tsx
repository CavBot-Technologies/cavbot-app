...
export default function FramerPlatformPage() {
          ...
          <div className="sx-topLeft">
            <div className="cb-heroTitle">
              <div className="cb-heroIcon" aria-hidden="true">
                <Image src="/integrations/white-mark.svg" alt="Framer logomark" width={54} height={54} priority={true} unoptimized />
              </div>
              <div>
                <h1 className="sx-h1">Framer Integration</h1>
                <p className="sx-sub">
                  Install CavBot on Framer to serve a secured, interactive CavBot recovery experience on your 404 route.
                </p>
...
<br /><br /><br /><br />
        <section className="sx-panel cb-installPanel cb-spacedPanel" aria-label="Install steps">
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub cb-longCopy">
                This script instructs Framer to load CavBot Arcade, widgets, analytics, and CavAi while keeping your 404 route secure and interactive.
              </p>
              <p className="sx-status-sub cb-longCopy">
                Framer lets you inject Custom Code in Project Settings → General; keep this guide visible so you can paste the loader into the “End of head tag” field exactly once for the whole site.
              </p>
            </div>
          </header>
          <div className="sx-body">
            <div className="cb-pathIntro">
              <p className="sx-footK">Project Settings → Custom Code</p>
              <br />
              <br />
              <p className="sx-status-sub">
                Adding the loader to the “End of head tag” ensures CavBot sees 404 traffic consistently across every published page and error route.
              </p>
            </div>
            <div className="cb-stepGrid">
              <article className="cb-stepEntry">
                <strong>Open your Framer project</strong>
                <br />
                <br />
                <p className="sx-status-sub">
                  Log in to Framer and open the project that hosts the site you want to protect.
                </p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  In the Framer editor, click the gear icon (Project Settings) in the top-right corner.
                </p>
              </article>
              <article className="cb-stepEntry">
                <strong>Locate Custom Code</strong>
                <br />
                <br />
                <p className="sx-status-sub">
                  Inside Project Settings, open the General section and scroll down to “Custom Code.”
                </p>
              </article>
              <article className="cb-stepEntry">
                <strong>Paste CavBot loader snippet (Head)</strong>
                <br />
                <br />
                <p className="sx-status-sub">
                  Paste the CavBot Arcade Loader snippet (generated below) into the “End of head tag” field. Head placement gives the most reliable detection and cleanest 404 activation.
                </p>
                <p className="sx-status-sub">
                  If Framer shows extra fields like “Start of body tag” or “End of body tag,” ignore them for this integration—only the head field needs the loader.
                </p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  Click Save, then publish your site so the Custom Code changes face your live domain.
                </p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  Open your published site in a new tab and visit a path that does not exist (for example https://yourdomain.com/this-route-does-not-exist). Your Framer 404 page should load and CavBot Arcade will mount automatically.
                </p>
              </article>
              <article className="cb-stepEntry">
                ...
                <br />
                <p className="sx-status-sub">
                  Return to CavBot → Settings → Integrations → Framer. The panel below should flip from “Not detected” to “Detected” and show the last seen timestamp, origin, and selected game.
                </p>
              </article>
            </div>
          </div>
        ...
        <section className="sx-panel cb-spacedPanel" aria-label="Loader snippets">
          <header className="sx-panelHead">
            <div>
              <h2 className="sx-h2">Loader snippets — site-wide injection</h2>
              <p className="sx-sub">
                The loader, widget, analytics, and CavAi snippets now sit below the install steps so you can grab the cards after pasting the loader into Custom Code’s End of head tag.
              </p>
            </div>
          </header>
          <div className="sx-body">
        ...
        <section className="sx-panel cb-spacedPanel" aria-label="Dedicated 404 instructions">
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub">
                If your Framer project gives you a customizable 404 page or you prefer page-specific settings, paste the Arcade loader there for determinism.
              </p>
            </div>
          </header>
          <div className="sx-body cb-dedicated404">
            <div className="cb-dedicatedRow">
              <p className="sx-status-sub cb-dedicatedSentence">
                This is the most deterministic setup because CavBot only runs when Framer returns a real 404 response.
            ...
            <p className="sx-status-sub cb-dedicatedFollow">
              ...
              <code>data-cavbot-page-type=&quot;404&quot;</code> attribute on <code>&lt;body&gt;</code> so Framer knows this page serves 404 traffic.
            </p>
            <p className="sx-status-sub cb-dedicatedFollow">
              If you want CavBot only on a single page, open that page in Page Settings, paste the loader into its “End of head tag,” then publish again.
            </p>
          </div>
        </section>
        ...
        <section className="sx-panel cb-spacedPanel" aria-label="Quick verification">
          ...
          <div className="sx-body cb-testSection">
            <ol className="cb-testList">
              <li>Save the Custom Code entry in Framer and publish your site so the CavBot snippet is live on the published domain.</li>
              <li>Open the published Framer site in a new tab and visit a URL that does not exist.</li>
            ...
            <p className="sx-status-sub cb-testParagraph">
              Once CavBot hits that fake path, Arcade detections will appear in the panel below within a few seconds.
            </p>
            <p className="sx-status-sub cb-testParagraph">
              While you&apos;re testing, verify the widget badge loads, analytics pings your workspace, and CavAi starts behind the scenes.
            </p>
            <p className="sx-status-sub cb-testParagraph">
              Framer requires you to publish after editing Custom Code; if detection doesn&apos;t flip immediately, hard refresh the 404 page, confirm you published the correct domain, and wait ~1–2 minutes before retrying.
            </p>
            <p className="sx-status-sub cb-testParagraph">
              The domain MUST be added to CavBot&apos;s Origin Allowlist or verification will fail.
            </p>
            <p className="sx-status-sub cb-testParagraph">
              If you maintain staging or multiple site versions (www + non-www), add both domains to the allowlist and keep the snippet on the published domain.
            </p>
          </div>
        </section>
          ...
          <div className="sx-body cb-troubleshoot">
            ...
            <details>
              ...
              <ul>
                ...
                <li>Ensure the loader snippet lives in Custom Code’s “End of head tag” so it runs before the page renders.</li>
                <li>Framer caches aggressively; publish changes, hard refresh the 404 page, and wait ~1–2 minutes if detection does not flip immediately.</li>
              </ul>
            </details>
          </div>
        </section>
          ...
          <header className="sx-panelHead">
            <div>
              ...
              <p className="sx-sub">
                ...
                to validate your CavBot snippet or manage any exported HTML/CSS before publishing to Framer.
              </p>
            </div>
